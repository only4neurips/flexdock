...
class Unbound_Bound_Data(Dataset):
    ...
    def __init__(self, args, if_swap=True, reload_mode='train',
        ...
        if load_from_cache:
            ...
            # split_files_path = '/apdcephfs/share_1364275/kaithgao/flexdock_git/flexdock_0425/data/benchmark5.5/cv/cv_0'
            ...
            for result in preprocess_result:
                ...
                bound_ligand_repres_nodes_loc_array, bound_receptor_repres_nodes_loc_array, pocket_coors, \
